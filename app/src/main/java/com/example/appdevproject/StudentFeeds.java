...
public class StudentFeeds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       recyclerViewinterest.setLayoutManager(new LinearLayoutManager(this));
        ...
        interestsClasseslist.add(new InterestsClass("           Designing","For Designing we have to use software Adobe Illustrator and For some user Interface designing we have to use figma.",R.drawable.llustrator,R.drawable.youtube,R.drawable.youtube,R.drawable.youtube,"https://getintopc.com/softwares/designing-tool/adobe-illustrator-cc-2021-free-download/","https://www.youtube.com/watch?v=j7PEuMumhMs","https://www.youtube.com/watch?v=vd1vRpoWC3M&list=PLW-zSkCnZ-gCq0DjkzY-YapCBEk0lA6lR","https://www.youtube.com/watch?v=3q3FV65ZrUs&list=PLbJ5xQS-9bLAGg-KwN3ebJiu9m0rrKj6F/"));
        interestsClasseslist.add(new InterestsClass("          Video Editing","For Video Editing we have to use software Adobe Premium Pro.",R.drawable.premium,R.drawable.youtube,R.drawable.youtube,R.drawable.youtube,"https://getintopc.com/softwares/video-editing/adobe-premiere-pro-cc-2021-free-download/","https://www.youtube.com/watch?v=V5sENw2C97s&list=PLBrRXoTJAkZBl3XDQEPjVj4okFAHQrVex","https://www.youtube.com/watch?v=h6eeDgBjZq8&list=PLW-zSkCnZ-gABGZU8--ISUauyewG40Yex","https://www.youtube.com/watch?v=O6ERELse_QY"));

        interestsClasseslist.add(new InterestsClass("          Animation","For Animation we have to use software After effects.",R.drawable.aftereffect,R.drawable.youtube,R.drawable.youtube,R.drawable.youtube,"https://getintopc.com/softwares/video-editing/adobe-after-effects-cc-2020-free-download-1602160/","https://www.youtube.com/watch?v=J9bAd28DzTU&list=PLCE5MltCMHTrDXCxoHmUhpBuxDxgHasTv","https://www.youtube.com/watch?v=F62v0cAAsgY&list=PLuz8v_brMXJZZ1jOi6ufaSdCm9AJnHJi1","https://youtu.be/yPha_s7W-0M"));
